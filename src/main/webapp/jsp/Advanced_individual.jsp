...
<div class="ta">
    ...
    <div class="apply">
        ...
        <div id="step1">
            ...
            <input type="button" class="cc1" onclick="getnext('step2')" value="下一步">
        ...
        <div id="step2">
            ...
            <input type="button" class="cc2" onclick="getnext('step3')" value="下一步">
        ...
        <div id="step3">
            ...
            <input type="button" class="cc2" onclick="getnext('step4')" value="下一步">
            <input type="button" class="cc3" onclick="cancel()" value="取消">
        </div>
        <%--        第四个小页面--%>
        <div id="step4">
